...
wget --progress=dot:giga -O /tmp/test.img "http://ci.syncloud.org:8081/files/image-v2/output/syncloud-odroid-n2.img"
ls -lh /tmp/test.img
...
echo "=== Step 5: mount p2 ==="
mkdir -p /tmp/mnt
mount "/dev/mapper/${LOOP_NAME}p2" /tmp/mnt
df -h /tmp/mnt

echo "=== Step 6: write 1GB to simulate tar extract ==="
